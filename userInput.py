...
averaage=(num1+num2+num3)/3
print("average of three numbers : ",averaage)
# 8. Write a python script to calculate simple interest
p=int(input("Enter Principal amount : "))
r=int(input("Entre Annual interest rate : "))
n=int(input("Enter Term of loan, in years : "))
...
Volume_of_a_cuboid =l*b*h
print("Volume of a cuboid = ",Volume_of_a_cuboid) 
# 10. Write a python script to calculate area of a rectangle
l=int(input("Enter length : "))
w=int(input("Enter width : "))
area_of_a_rectangle=l*w
